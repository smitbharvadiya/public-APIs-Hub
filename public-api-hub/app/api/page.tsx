...
// This should be your categories JSON
...
export default function APIsPage() {
    ...
    const filteredCategories = categories.filter((cat) => {
        const searchContent = `${cat.name} ${cat.description}`.toLowerCase();
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="relative w-full md:w-80 group">
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-full px-6 py-4 text-sm focus:outline-none focus:border-lime-400/50 transition-all placeholder:text-gray-600"
                        />
                    </div>
                </div>
            </header>
